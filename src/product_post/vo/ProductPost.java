...
public ProductPost(int pro_no,String pro_img,String pro_title,int pro_pirce,Date pro_date,int pro_stock,int pro_delivery_fee,int pro_cate_no) {
		this.pro_no=pro_no;
...
//상품등록
public ProductPost(int pro_cate_no, String pro_title, String pro_img, int pro_pirce, int pro_delivery_fee, int pro_stock) {
	this.pro_cate_no=pro_cate_no;
	this.pro_title=pro_title;
	this.pro_img=pro_img;
	this.pro_pirce=pro_pirce;
...
public int getPro_pirce() {
	return pro_pirce;
}
public void setPro_pirce(int pro_pirce) {
	this.pro_pirce = pro_pirce;
}
...
public String toString() {
	return "ProductPost [pro_no=" + pro_no + ", pro_img=" + pro_img + ", pro_title=" + pro_title + ", pro_pirce="
			+ pro_pirce + ", pro_date=" + pro_date + ", pro_stock=" + pro_stock + ", pro_delivery_fee="
